...
if ( -e ${ATLAS_LOCAL_ROOT}/root/${ATLAS_LOCAL_CERNROOT_VERSION}/.alrb/lcgenv ) then
    source ${ATLAS_LOCAL_ROOT}/root/${ATLAS_LOCAL_CERNROOT_VERSION}/setup.csh
else
...
unset alrb_oldRootSys alrb_result alrb_rc alrb_rootRealVersion alrb_tmpAr alrb_item alrb_tmpVal 
#alrb_rootVirtVersion
