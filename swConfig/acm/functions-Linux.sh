...
Usage: lsetup [global options] "${alrb_sw} [options] <version>"
    ...
    This sets up the ATLAS environment for acm
...
# do we have an error here ?
	...
	local alrb_swVersion=$ALRB_acmVersion
    else
...
# dependencies
	...
	\echo "Error: acm version undetermined or unavailable $alrb_swVersion" 1>&2
	return 64
    fi
}
